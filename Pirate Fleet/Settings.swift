...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! This giant marine reptile is comin'for your ships!"
        static let ComputerHitMonster = "The computer has hit a sea monster! Laugh while this monster do your job!"
